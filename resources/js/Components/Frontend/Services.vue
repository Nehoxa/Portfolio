  ...
  <section id="services" class="section bg-light-secondary dark:bg-dark-secondary">
    ...
    >
      <div class="flex flex-col items-center text-center">
        <h2 class="section-title">Que puis-je faire pour vous ?</h2>
      </div>
      <div class="grid lg:grid-cols-4 gap-8 mt-16">
        <div class="bg-light-tail-100 dark:bg-dark-navy-500 p-6 rounded-2xl">
          ...
          <h4 class="text-xl font-medium mb-2">Web Développement</h4>
          <p>
            Créer ou ajout de nouvelle fonctionnalité de votre applcation web.
          </p>
        </div>
        <div class="bg-light-tail-100 dark:bg-dark-navy-500 p-6 rounded-2xl">
          <div class="
          ...
          <p>
            Mise en place du design de votre application.
          </p>
        </div>
        <div class="bg-light-tail-100 dark:bg-dark-navy-500 p-6 rounded-2xl">
          <div class="
