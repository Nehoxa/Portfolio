  ...
  <section class="section bg-light-secondary dark:bg-dark-secondary">
    <div class="container mx-auto">
      <div class="flex flex-col items-center text-center">
        ...
        <p class="subtitle">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. In deserunt ipsum esse sequi veniam nam explicabo
          ex, ad voluptates! Aut beatae laudantium distinctio qui, impedit tempora sunt! Nisi, dolorum iste?
        </p>
      </div>
